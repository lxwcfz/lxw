<template>
    <div class="addProducts">
        <el-tabs v-model="activeName">
            <el-tab-pane :label="$t('products.addItem')" name="first">
                            ...
                            <div class="form-content">
                                <el-form ref="productForm" :model="productForm" :rules="rules" label-width="100px">
                                    ...
                                    <el-form-item :label="$t('products.addItemPage.itemDesc')" prop="itemDesc">
                                        <el-input type="textarea" :rows="3" :placeholder="$t('placeholder.itemDesc')" v-model="productForm.itemDesc" @blur="translateContent(productForm.itemDesc,'desc')">
                                        </el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item :label="$t('products.addItemPage.setmealItems')" v-if="productForm.itemType == 2">
                                        ...
                                        <el-table :data="setmealList" border style="width: 100%; margin-top:10px;" max-height="250">
                                            <el-table-column :label="$t('products.addItemPage.itemName')" width="120">
                                    ...
                                    <el-form-item :label="$t('products.addItemPage.salesTime')" prop="timeDurations" v-if="productForm.itemType != 3">                                        
                                        ...
                                        <el-popover ref="popoverTime" placement="top" width="160" v-model="timeSelectVisible">
                                            <p>
                                                <template>
                                        ...
                                        <template>
                                            <el-card class="box-card">
                                                ...
                                                <el-table :data="attrGroups" border style="width: 100%; text-align:center; margin-top:10px;" max-height="250">
                                                    <el-table-column :label="$t('products.addItemPage.name')" width="120">
                                                        <template scope="scope">                                                            
                                ...
                                <div class="btn-fixed">
                                    ...
                                    <el-button @click="saveAddNext('save')">{{$t('products.addItemPage.saveToAdd')}}</el-button>
